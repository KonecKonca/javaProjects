...
public class start{
    ...
    static List<f> figures = new ArrayList<>();
    public static class f{
        public List<String> figura = new ArrayList<>();
    }
            ...
            if(RebroWithPartALotOfFigures() == ""){
               ...
               // List<Integer> help = new ArrayList<>();
                for(int i = 0; i < figures.size(); i++){
                    for(int j = 0; j < figures.get(i).figura.size(); j++){
                        if(IncedentList.compareRebra(figures.get(i).figura.get(j), remove)){
                           // help.add(i);
                            for(int z = 0; z < figures.get(i).figura.size(); z++){
                                for(int ii = 0; ii < list.size(); ii++){
                                    list.get(ii).dicrementNumAsApartOfFigure(figures.get(i).figura.get(z));
                                }
                            }
                            break;
                        }
...
//                    for(int j = 0; j < figures.get(help.get(i)).figura.size(); j++){
//                        for(int z = 0; z < figures.get(i).figura.size(); z++){
//                            for(int ii = 0; ii < list.size(); ii++){
//                                list.get(ii).dicrementNumAsApartOfFigure(figures.get(i).figura.get(z));
//                            }
...
//        for(int i = 0; i < figures.size(); i++){
//            for(int j = 0; j < figures.get(i).figura.size(); j++){
//                System.out.print(figures.get(i).figura.get(j) + "  ");
//            }
//            System.out.println();
//        }
                        ...
                        for(int ii = 0; ii < list.get(mass[i]).kolReber(); ii++){
                            for(int jj = 0; jj < list.get(mass[j]).kolReber(); jj++){
                                if(IncedentList.compareRebra(list.get(mass[i]).getRebro(ii), list.get(mass[j]).getRebro(jj))){
                                    ...
                                    fig.figura.add(list.get(mass[i]).getRebro(ii));
                                }
                            }
                        }
                    }
                                ...
                                for(int ii = 0; ii < list.get(mass1[i]).kolReber(); ii++){
                                    for(int jj = 0; jj < list.get(mass2[j]).kolReber(); jj++){
                                        if(IncedentList.compareRebra(list.get(mass1[i]).getRebro(ii), list.get(mass2[j]).getRebro(jj))){
                                            ...
                                            fig.figura.add(list.get(mass1[i]).getRebro(ii));
                                        }
                                    }
                                }
                            }
