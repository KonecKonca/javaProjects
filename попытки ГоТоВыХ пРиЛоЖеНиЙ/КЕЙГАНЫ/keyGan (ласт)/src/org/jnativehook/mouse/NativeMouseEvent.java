  ...
  extends NativeInputEvent
{
  ...
  public NativeMouseEvent(int paramInt1, int paramInt2, int paramInt3, int paramInt4, int paramInt5)
  {
    this(paramInt1, paramInt2, paramInt3, paramInt4, paramInt5, 0);
  }
  
  public NativeMouseEvent(int paramInt1, int paramInt2, int paramInt3, int paramInt4, int paramInt5, int paramInt6)
  {
...
/* Location:              D:\Time\jnativehook-2.1.0.jar!\org\jnativehook\mouse\NativeMouseEvent.class
