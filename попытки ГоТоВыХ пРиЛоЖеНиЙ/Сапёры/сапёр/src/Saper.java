...
public class Saper extends JFrame {
    ...
    private Icon flag = new ImageIcon(getClass().getResource("флажок.JPG"));
    private Icon bomba = new ImageIcon(getClass().getResource("бомба.JPG"));
    private Icon question = new ImageIcon(getClass().getResource("вопрос.JPG"));
    ...
    public Saper(){
        ...
        numbers[0] = new ImageIcon(getClass().getResource("1.JPG"));
        numbers[1] = new ImageIcon(getClass().getResource("2.JPG"));
        numbers[2] = new ImageIcon(getClass().getResource("3.JPG"));
        numbers[3] = new ImageIcon(getClass().getResource("4.JPG"));
        numbers[4] = new ImageIcon(getClass().getResource("5.JPG"));
        numbers[5] = new ImageIcon(getClass().getResource("6.JPG"));
        numbers[6] = new ImageIcon(getClass().getResource("7.JPG"));
        numbers[7] = new ImageIcon(getClass().getResource("8.JPG"));
