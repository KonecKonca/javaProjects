  ...
  extends NativeInputEvent
{
  ...
  public NativeKeyEvent(int paramInt1, int paramInt2, int paramInt3, int paramInt4, char paramChar, int paramInt5)
  {
    super(GlobalScreen.class, paramInt1, paramInt2);
    this.rawCode = paramInt3;
    this.keyCode = paramInt4;
    this.keyChar = paramChar;
    this.keyLocation = paramInt5;
    if ((paramInt1 == 2400) && ((paramChar == 65535) || (paramInt4 != 0))) {
      throw new IllegalArgumentException();
    }
  }
  
  public NativeKeyEvent(int paramInt1, int paramInt2, int paramInt3, int paramInt4, char paramChar)
  {
    this(paramInt1, paramInt2, paramInt3, paramInt4, paramChar, 0);
  }
  ...
  public String paramString()
  {
    ...
    case 2402: 
      ...
      break;
    case 2400: 
      localStringBuilder.append("NATIVE_KEY_TYPED");
      break;
    default: 
    ...
    case '\034': 
    case '๓': 
      localStringBuilder.append(getKeyText(this.keyChar));
      break;
    case '￿': 
      localStringBuilder.append(getKeyText(0));
      break;
    default: 
      localStringBuilder.append('\'');
      localStringBuilder.append(this.keyChar);
      localStringBuilder.append('\'');
    }
    localStringBuilder.append(',');
    if (getModifiers() != 0)
...
/* Location:              D:\Time\jnativehook-2.1.0.jar!\org\jnativehook\keyboard\NativeKeyEvent.class
