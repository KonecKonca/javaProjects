...
public class FileController {
	...
	@ResponseBody
	public ModelAndView uploadFile(@ModelAttribute("uploadedFile") UploadedFile uploadedFile, BindingResult result) throws IOException {// имена параметров - как на форме jsp
...
//	    logger.error("IOExcepion handler executed");
//
//	    ModelAndView modelAndView = new ModelAndView("error");
//	    modelAndView.addObject("error", "pizda");
//
//	    return modelAndView;
//    }
